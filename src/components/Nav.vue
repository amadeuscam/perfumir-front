  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light vh-10">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav ms-xl-auto">
        <li class="nav-item">
          <router-link class="nav-link active" to="/ingredients">Ingredients</router-link>
        </li>
        <li class="nav-item">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-xl-auto mb-2 mb-lg-0" v-if="!username">
          <li class="nav-item">
        ...
        <ul class="navbar-nav ms-xl-auto mb-2 mb-lg-0" v-if="username">
          <li class="nav-item">
            <p class="nav-link fw-bold">{{ username }}</p>
          </li>
          <li class="nav-item">
            <a class="nav-link text-danger" style="cursor: pointer" @click="handleClick">Salir</a>
          </li>
        </ul>
      </div>
    </div>
